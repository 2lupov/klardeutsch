        ...
        {!isTelegram && (
          <div className="mt-3 animate-auth-fade-up" style={{ animationDelay: "0.7s" }}>
            ...
            <button
              ...
              className="w-full px-5 py-3 rounded-xl border border-border bg-secondary text-foreground font-semibold text-sm transition-all hover:bg-secondary/80 flex items-center justify-center gap-3 disabled:opacity-50 mb-3"
            >
