...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Подтверди email для KLAR',
  invite: 'Приглашение в KLAR',
  magiclink: 'Ссылка для входа в KLAR',
  recovery: 'Сброс пароля KLAR',
  email_change: 'Подтверждение смены email в KLAR',
  reauthentication: 'Код подтверждения KLAR',
}
...
const SAMPLE_PROJECT_URL = "https://klardeutsch.lovable.app"
